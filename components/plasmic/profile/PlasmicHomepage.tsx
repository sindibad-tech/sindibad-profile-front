                                      ...
                                      return (async () => {
                                        ...
                                        try {
                                          const response = await fetch(
                                            "https://travel-stats-image.vercel.app/imageGet",
                                            {
                                              method: "POST",
                                              headers: {
                                                "Content-Type":
                                                  "application/json",
                                                Authorization:
                                                  "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..wiqUAmFMZOfbrE0xYyhL6LAkuRFhJTme_yvrLloun-4"
                                              },
                                              body: JSON.stringify({})
                                            }
                                          );
                                          ...
                                          if (navigator.share) {
                                            await navigator.share({
                                              title: "Check out my trip stats!",
                                              text: "Here are my travel stats generated by Sindibad.",
                                              url: imageUrl
                                            });
                                            alert("Image shared successfully!");
                                          } else {
                                            alert(
                                              `Image shared successfully! View it here: ${imageUrl}`
                                            );
                                          }
                                        } catch (error) {
                                          console.error(
